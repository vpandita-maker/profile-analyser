...
export default function UnlockedResultsPage() {
  ...
  const lockedFixes = hasFixes ? analysis.secondaryFixes.slice(0, 3) : [];
            ...
            <div className="mb-4">
              {isFullyUnlocked ? (
                ...
                <div>
                  ...
                  <div ref={lockSectionRef} className="mt-1">
                    <ShareUnlockCard
                      lockedCount={lockedFixes.length}
                      onUnlocked={() => setFullyUnlocked(true)}
                    />
                  </div>
                </div>
              )}
